...
// [[Rcpp::export]]
float unweightedEntropySimilarity(
...
// [[Rcpp::export]]
float_spec spectralEntropy(const float_spec *spectrum, int spectrum_length) {
    return calculate_spectral_entropy(spectrum, spectrum_length);
}
